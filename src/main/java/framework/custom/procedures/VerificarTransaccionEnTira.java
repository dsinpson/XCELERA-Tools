...
public class VerificarTransaccionEnTira implements IPerformableProcedure {

    Logger logger=Logger.getLogger(VerificarTransaccionEnTira.class.getName());
    ...
    public VerificarTransaccionEnTira(Procedure procedure, ScreenshotHelper screenshotHelper) {
