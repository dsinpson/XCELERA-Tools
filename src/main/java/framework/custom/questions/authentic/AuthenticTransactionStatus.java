...
public class AuthenticTransactionStatus implements IQuestion<String[]> {

    Connection conexion;
    ResultSet rs;
    Logger logger=Logger.getLogger(AuthenticTransactionStatus.class.getName());
    ...
    public AuthenticTransactionStatus(String idCajero, String trxType, String messageType, String authenticInternalCode) {
    ...
    public static AuthenticTransactionStatus with(String idCajero, String trxType, String messageType, String authenticInternalCode){
        return new AuthenticTransactionStatus(idCajero, trxType, messageType, authenticInternalCode);
    }
    ...
    public String[] ask() throws SQLException {
        ...
        strQuery = "SELECT * FROM ("+
                ...
                "AND A.TRL_TSC_CODE = %s "+
                "ORDER BY A.TRL_DATETIME_LOCAL_TXN DESC "+
                ")WHERE ROWNUM = 1";

        String sentenciaSQLCompleta = String.format(strQuery, fechaHora, idCajero, trxType, messageType,  authenticInternalCode);
        ...
        if (!authorisedBy.equals("authentic") && (actionCode.equals("0") || actionCode.equals("000") || actionCode.equals("0000")) ) {
            actionCode = "00";
        }

        ConexionAuthentic.util().desconectar(conexion);

        return new String[]{traxType, messageType, authenticInternalCode, actionCode, authorisedBy, sentenciaSQLCompleta};
    }
}
